...
const AdminLanding = () => {
  return (
    <div className=" h-[100vh] w-[100vw] home-bg flex flex-col md:flex-row items-center justify-center">
      <div
        className=" w-[80%] py-6 md:w-[35%] md:h-[65%] mx-7 my-4 h-[100vh]"
      >
        <FadeInWrapper>
          <div className=" w-full h-full bg-white flex items-center justify-center flex-col rounded-lg shadow-sm shadow-slate-500">
            <div>
